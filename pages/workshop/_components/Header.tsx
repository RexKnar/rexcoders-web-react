...
import Info from 'components/blocks/navbar/partials/Info';
import Search from 'components/blocks/navbar/partials/Search';
import Social from 'components/blocks/navbar/partials/Social';
import Signin from 'components/blocks/navbar/partials/Signin';
import Signup from 'components/blocks/navbar/partials/Signup';
import Language from 'components/blocks/navbar/partials/Language';
import MiniCart from 'components/blocks/navbar/partials/MiniCart';
// -------- data -------- //
import { navItems } from 'data/navigation';
import OneToOne from 'components/blocks/navbar/partials/OneToOne';
  ...
  const headerContent = (
    <>
      <div className="navbar-brand w-90">
        <NextLink href="/" title={<img alt="logo" src={`/img/${logo}@2x.png`} srcSet={`/img/${logo}@2x.png 2x`} />} />
      </div>
