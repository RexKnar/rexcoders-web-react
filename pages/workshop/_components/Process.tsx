    ...
    return (
        <section id="snippet-12" className="wrapper bg-light ">
            <div className="container pt-15 pt-md-17 pt-lg-20 pb-lg-2 pb-13 pb-md-15">
                ...
                <ul role="tablist"
                    className="nav b-0 d-flex justify-content-between nav-justified flex-lg-row flex-column">
                    <li className="nav-item" role="presentation">
                        <div role="tab" data-bs-toggle="tab"
                            aria-selected="true" className="nav-link d-lg-flex d-md-flex d-block">
                            {processList7.map(({ Icon, color, ...item }) => (
                                <div className="col-12 col-md-6 col-lg-4" key={item.id}>
                                    <ServiceCard7 {...item} Icon={<Icon className={`icon-svg-sm text-${color} me-4`} />} />
                                </div>
                            ))}
                        </div>
                    </li>
