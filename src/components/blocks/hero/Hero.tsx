...
<h1 className='mb-5 display-2' style={slideInDownAnimate('30ms')}>Become a <span className='text-primary'> Job Ready </span> Software Developer </h1>
              <p className='lead fs-sm lh-sm mb-7 pe-xl-10' style={slideInDownAnimate('290ms')}>
              Practical, mentor-led programs <b>designed for college students and fresh graduates</b> who want to <b>start a successful IT career.</b>
