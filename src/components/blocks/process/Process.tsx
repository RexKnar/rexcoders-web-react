...
const Process: FC = () => {
  return (
    <div className="row gx-md-8 gx-xl-12 gy-10 mb-14 mb-md-18 align-items-center">
      ...
      <div className="col-lg-6">
        <h2 className="mb-3 fs-16 text-uppercase text-muted">Our Strategy</h2>
        <h3 className="mb-5 display-4">Here are 3 working steps to organize our business projects.</h3>
        ...
        <NextLink href="#" title="Learn More" className="mb-0 btn btn-primary rounded-pill" />
      </div>
    </div>
  );
};
